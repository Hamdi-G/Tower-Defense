...
#include "../include/GraphicPrimitives.h"
...
void GraphicPrimitives::drawText2D(char * str,float x,float y,float r,float g, float b,void * font,float a){
  glPushMatrix();
  glPushAttrib(GL_CURRENT_BIT);
...
void GraphicPrimitives::drawSmallText2D(char * str,float x,float y,float r,float g, float b,float a){
  glPushMatrix();
  glPushAttrib(GL_CURRENT_BIT);
  //on doit definir la couleur avant la fonction RasterPos sinon elle ne sera pas prise en compte ...
  glColor4f(r,g,b,a);
...
void GraphicPrimitives::drawBigText2D(char * str,float x,float y,float r,float g, float b,float a){
  glPushMatrix();
  glPushAttrib(GL_CURRENT_BIT);
  //on doit definir la couleur avant la fonction RasterPos sinon elle ne sera pas prise en compte ...
  glColor4f(r,g,b,a);
...
void GraphicPrimitives::drawFillTower2D(float x,float y, int size,float r,float g, float b,float a){
  std::vector<float> xOut{0.01f,0.09f,0.075f,0.09f,0.09f,0.07f,0.07f,0.06f,0.06f,0.04f,0.04f,0.03f,0.03f,0.01f,0.01f,0.025f};
  std::vector<float> yOut{0.005f,0.005f,0.07f,0.08f,0.095f,0.095f,0.088f,0.088f,0.095f,0.095f,0.088f,0.088f,0.095f,0.095f,0.08f,0.07f};
  ...
  std::vector<float> xx{0.09,0.01,0.075,0.025,0.09,0.01,0.09,0.01};
  std::vector<float> yy{0.005,0.005,0.07,0.07,0.08,0.08,0.088,0.088};
  ...
  drawFillPolygone2D(xx,yy,r,g,b);
  drawFillRect2D(xOut[6],yOut[6],xOut[4]-xOut[5],yOut[5]-yOut[6],r,g,b);
  drawFillRect2D(xOut[10],yOut[6],xOut[4]-xOut[5],yOut[5]-yOut[6],r,g,b);
  drawFillRect2D(xOut[0],yOut[6],xOut[4]-xOut[5],yOut[5]-yOut[6],r,g,b);
  drawOutlinedPolygone2D(xOut,yOut,0.0,0.0,0.0);
  drawFillRect2D((0.045 * size) + x ,(0.035 * size) + y, 0.01 * size, 0.03 * size,0,0,0);
}
