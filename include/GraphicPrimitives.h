...
public:
     ...
     */
    static void drawText2D(char * str,float x,float y,float r,float g, float b,void * font = GLUT_BITMAP_HELVETICA_18,float a = 1.0f);

    /**
     * Ecrit le texte a l'ecran
     */
    static void drawSmallText2D(char * str,float x,float y,float r,float g, float b,float a = 1.0f);

    /**
     * Ecrit le texte a l'ecran
     */
    static void drawBigText2D(char * str,float x,float y,float r,float g, float b,float a = 1.0f);
    ...
    static void drawFillTower2D(float x,float y, int size,float r,float g, float b,float a = 1.0f);
